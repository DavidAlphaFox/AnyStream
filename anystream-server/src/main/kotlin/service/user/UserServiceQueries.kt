...
interface UserServiceQueries {
    ...
    suspend fun createUser(user: User, passwordHash: String, permissions: Set<String>): UserDb?
    ...
    suspend fun createInviteCode(secret: String, permissions: Set<String>, userId: Int): InviteCode?
